...
func newMockStore(t *testing.T) (*Store, pgxmock.PgxPoolIface, *fakePages) {
	...
	//
	// 7 of this package's 9 expectations were unverified. Control E4 deleted Delete's
	// statement; the mock test stayed green and only SEC4_L2 spoke — through the
	// RowsAffected⇒ErrNotFound branch that went with it, which is the tenancy half, not an
	// assertion that the row is gone.
	//
