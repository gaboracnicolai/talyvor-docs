...
func newMockStore(t *testing.T) (*Store, pgxmock.PgxPoolIface) {
	...
	//
	// 12 of this package's 15 expectations were unverified, including both Unlock
	// success tests. Control E2 deleted the unlock UPDATE; the mock tests stayed green and
	// THREE real-PG tests spoke instead (failclosed_gate, sec_isadmin, sec_root_actor). A
	// prediction that nothing would notice was wrong, and the protection is entirely elsewhere.
	//
